...
STAGE = ROOT / "_stage_alpha6744_40"
MOD_STAGE = STAGE / "Team Up"
LOG = ROOT / "BUILD_LOG_ALPHA6744_40.txt"
VERSION = "0.2.0-alpha.6.7.44.40"
ZIP_NAME = "TeamUp_v0.2.0-alpha.6.7.44.40_FINAL_RUNTIME_CLOSURE_TEST.zip"
ZIP_PATH = RELEASE / ZIP_NAME
SHA_PATH = RELEASE / "TeamUp_v0.2.0-alpha.6.7.44.40_FINAL_RUNTIME_CLOSURE_TEST.sha256.txt"
lines: list[str] = []
...
try:
    ...
    log("VERSION IDENTITY 6.7.44.40: PASS")
    ...
    for rel in forbidden:
        req(not (SRC / rel).exists(), f"old crash-stack service leaked into 44.40: {rel}")
    ...
    for token in [
        ...
        "Alpha674440Version = \"0.2.0-alpha.6.7.44.40\"",
        "Alpha674440Branch = \"v0.2-alpha6-7-44-40-final-runtime-closure\"",
    ]:
    ...
    log("BUILD SUCCESS - ALPHA 6.7.44.40 FINAL RUNTIME CLOSURE")
    log(f"ZIP: {ZIP_NAME}")
    log(f"SHA256: {digest}")
finally:
    LOG.write_text("\n".join(lines) + "\n", encoding="utf-8")

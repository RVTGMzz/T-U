...
STAGE = ROOT / "_stage_alpha6744_39"
MOD_STAGE = STAGE / "Team Up"
LOG = ROOT / "BUILD_LOG_ALPHA6744_39.txt"
VERSION = "0.2.0-alpha.6.7.44.39"
ZIP_NAME = "TeamUp_v0.2.0-alpha.6.7.44.39_RUNTIME_IDENTITY_NIDORAN_EXACT_TEST.zip"
ZIP_PATH = RELEASE / ZIP_NAME
SHA_PATH = RELEASE / "TeamUp_v0.2.0-alpha.6.7.44.39_RUNTIME_IDENTITY_NIDORAN_EXACT_TEST.sha256.txt"
lines: list[str] = []
...
try:
    ...
    log("VERSION IDENTITY 6.7.44.39: PASS")
    ...
    for rel in forbidden:
        req(not (SRC / rel).exists(), f"old crash-stack service leaked into 44.39: {rel}")
    ...
    log("BUILD SUCCESS - ALPHA 6.7.44.39 RUNTIME IDENTITY + NIDORAN EXACT SPAWN")
    log(f"ZIP: {ZIP_NAME}")
    log(f"SHA256: {digest}")
finally:
    LOG.write_text("\n".join(lines) + "\n", encoding="utf-8")

...
public sealed class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        Monitor.Log("Team Up DEBUG HARNESS READY | command: teamup_test | build: v0.2.0-alpha.6.4.4", LogLevel.Info);
        ...
        Monitor.Log("Team Up! v0.2.0-alpha.6.4.4 test feedback + equipment hotfix loaded.", LogLevel.Info);
    }

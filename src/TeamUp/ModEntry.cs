...
public sealed partial class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        helper.ConsoleCommands.Add(
            ...
            OnStrategyCommand);
        Monitor.Log("Team Up DEBUG HARNESS READY | command: teamup_test | build: v0.2.0-alpha.6.6.5", LogLevel.Info);
        ...
        Monitor.Log("Team Up! v0.2.0-alpha.6.6.5 Switch Input + Codex Profile Polish loaded.", LogLevel.Info);
    }

...
public sealed partial class ModEntry
{
    ...
    private void OnAlpha6617SlotCommand(string command, string[] args)
    {
        ...
        Monitor.Log(
            $"Team Up slot truth: reserved={Party.GetActiveCombatCompanionCount()}/{max}, effective={effective.Count}/{max}, livePelipperPlayer={livePlayers.Count}, runtimeRoot={PelipperVillagerLifecycleBridge.RootTypeName}.",
            LogLevel.Info);

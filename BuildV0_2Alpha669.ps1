...
try {
    ...
    if (-not $pelipperText.Contains('DeploymentStateKey = "Ronvotri.TeamUp/DeploymentState"')) {
        $pelipperText = Replace-Required $pelipperText `
            ...
            "    public const string CombatTargetOptInKey = \"Ronvotri.TeamUp/CombatTarget\";`n    public const string DeploymentStateKey = \"Ronvotri.TeamUp/DeploymentState\";`n    public const string DeploymentOwnerKey = \"Ronvotri.TeamUp/DeploymentOwner\";" `
            'Pelipper soft deployment contract constants'
    }
